...
namespace XGL {
	...
	public:
		Orbit();
		Orbit(const Vector3& position, const Vector3& target);
		~Orbit();
		...
		void moveTo(const Vector3& to, float duration = 0, AnimationMode mode = EASE_OUT);
		void moveForward(float delta, float duration = 0, AnimationMode mode = EASE_OUT);
		...
		void shiftTo(const Vector3& to, float duration = 0, AnimationMode mode = EASE_OUT);
		void shift(const Vector2& delta, float duration = 0, AnimationMode mode = EASE_OUT);
		...
		void rotateTo(const Vector3& angle, float duration = 0.0f, AnimationMode mode = EASE_OUT);
		void rotateTo(const Quaternion& quat, float duration = 0.0f, AnimationMode mode = EASE_OUT);
		void rotate(const Vector3& deltaAngle, float duration = 0.0f, AnimationMode mode = EASE_OUT);

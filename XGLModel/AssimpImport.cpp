...
void XGLModel::AssimpImport::init()
{
...
void XGLModel::AssimpImport::initShader()
{
	...
	readShader("../../XGLModel/AssimpImport.vert", vsSource);
	...
	readShader("../../XGLModel/AssimpImport.frag", fsSource);
